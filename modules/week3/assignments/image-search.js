...
class ImageSearch {
    constructor(url) {
        this.network =
         require('https'); // require the module needed to make requests
    }
        ...
        this
            ...
            .then((result) => {
                ...
                var jsonFlickrApi = function (photos) {
                    this
                        .getFlickrPhoto(photos['photos']['photo'][idx])
                        .then((contents) => {
    ...
    getFlickrPhoto(id) {
        // TODO
        https.get('https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=APIKEY&gallery_id=66911286-72157647277042064&format=json', (res) => {
